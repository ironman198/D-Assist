...
import com.google.android.gms.samples.vision.face.sleepAlert.ui.camera.CameraSourcePreview;
...
//            }
    ...
    public void exitbutton_m(View v) {

        System.out.println("Srini in exitButton");
        //Hiding sample button.
        jumbleButton.setVisibility(View.GONE);
//            this.drawview.exitbutton();
//        mp.stop();
        this.faceGraphic.stopMusic();
